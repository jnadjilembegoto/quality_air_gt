...
st.sidebar.markdown("---")
st.sidebar.image(issea, caption="Institut Sous régional de Statistique et d'Economie Appliquée", use_column_width=True)
st.sidebar.image(sei, caption="Stockholm Environment Institute", use_column_width=True)
st.sidebar.markdown("---")
